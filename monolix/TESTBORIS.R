...
nameproject<-"sierah_poisson_proj_2y"
#
...
predictepidemie<-function(binit, 
   ...
   jpeg(paste("./monolix/outputBoris/",nameproject,"/graphics/Epidemics365_",lengthconf,"_",as.character(indivParams[i,1]),".jpg",sep=""))
   par(mfrow=c(2,3))
   plot(temp_monolix_estim$solution[,"time"],temp_monolix_estim$solution[,"S"],type="l",xlab="Time",ylab="S",col="#56B4E9")
   plot(temp_monolix_estim$solution[,"time"],temp_monolix_estim$solution[,"E"],type="l",xlab="Time",ylab="E",col="#F0E442")
   plot(temp_monolix_estim$solution[,"time"],temp_monolix_estim$solution[,"I"],type="l",xlab="Time",ylab="I",col="#E69F00")
...
indivParams = read.table(paste("./monolix/outputBoris/",nameproject,"/IndividualParameters/estimatedIndividualParameters.txt",sep=""),header=TRUE,sep=",")[,c("id","transmission_mode","ascertainment_mode")]
...
dir.create(paste("./monolix/outputBoris/",nameproject,"/graphics",sep=""))
...
for (i in 1:length(indivParams$id)){
 K=3
  ...
  temp_monolix_estim<-seirah_estim(binit=as.numeric(indivParams[i,2:3]), 
    ...
    jpeg(paste("./monolix/outputBoris/",nameproject,"/graphics/FitI_",as.character(indivParams[i,1]),".jpg",sep=""))
    print(plot(temp_monolix_estim,type=1))
     dev.off()
     jpeg(paste("./monolix/outputBoris/",nameproject,"/graphics/FitH_",as.character(indivParams[i,1]),".jpg",sep=""))
     ...
     jpeg(paste("./monolix/outputBoris/",nameproject,"/graphics/Epidemics365_noaction_",as.character(indivParams[i,1]),".jpg",sep=""))
      par(mfrow=c(2,3))
       plot(temp_monolix_estim$solution[,"time"],temp_monolix_estim$solution[,"S"],type="l",xlab="Time",ylab="S",col="#56B4E9")
       plot(temp_monolix_estim$solution[,"time"],temp_monolix_estim$solution[,"E"],type="l",xlab="Time",ylab="E",col="#F0E442")
       plot(temp_monolix_estim$solution[,"time"],temp_monolix_estim$solution[,"I"],type="l",xlab="Time",ylab="I",col="#E69F00")
     ...
     dev.off()
      ...
      result30conf[i,]<-predictepidemie(binit=as.numeric(indivParams[i,2:3]), 
                                    ...
                                    newdailyMove=0,factorreductrans=K,obs="2Y")
...
write.table(result_noaction,file=paste("./monolix/outputBoris/",nameproject,"/graphics/indicateurs_results_noaction.txt",sep=""),row.names = F,quote=F)
write.table(result30conf,file=paste("./monolix/outputBoris/",nameproject,"/graphics/indicateurs_results_30conf.txt",sep=""),row.names = F,quote=F)
write.table(result90conf,file=paste("./monolix/outputBoris/",nameproject,"/graphics/indicateurs_results_90conf.txt",sep=""),row.names = F,quote=F)
write.table(result180conf,file=paste("./monolix/outputBoris/",nameproject,"/graphics/indicateurs_results_180conf.txt",sep=""),row.names = F,quote=F)
write.table(result270conf,file=paste("./monolix/outputBoris/",nameproject,"/graphics/indicateurs_results_270conf.txt",sep=""),row.names = F,quote=F)
write.table(result340conf,file=paste("./monolix/outputBoris/",nameproject,"/graphics/indicateurs_results_340conf.txt",sep=""),row.names = F,quote=F)
