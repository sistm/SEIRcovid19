...
newProject(modelFile = "./monolix/seirah_poisson1Y.txt",
           data = list(dataFile = "./monolix/data_region_20200322.txt",
                       headerTypes =c("ignore","ignore","ignore","time","observation","ignore","ignore","regressor","id","regressor","ignore"),
