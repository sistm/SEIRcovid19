...
# }
 ...
 seirah_solve_2period <- function(init, t, par){
   solution <- deSolve::ode(init, c(0,t[2]), seirah_ode_2period, par)
   ...
   #print(str(solution))
   colnames(solution) <- c("time", "S", "E", "I", "R", "A", "H")
   class(solution) <- c("seirah_solve_2period", "deSolve", "data.frame" )
   #print(solution)
   return(solution)
 }
