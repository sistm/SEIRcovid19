#' Meteorological stations dataset per French region (2021-03-03)
#'
#'A dataset containing the stations parameters at the region level.
#'The variables are as follows:
#'
#' \itemize{
#'   \item code_insee region insee code
#'   \item nom region name
#'   \item nuts2 Nomenclature of Territorial Units
#'   \item wikipedia wikipedia id
#'   \item surf_km2 surface covered in km2
#'   \item fid Geographical unique id
#'   \item field_1 same as fid
#'   \item usaf United States Air Force Id
#'   \item wban Wireless Body Area Network 
#'   \item station Station name
#'   \item ctry country id
#'   \item st state id
#'   \item call station indicator
...
#' }
#' @format A data frame with 257 rows and 25 variables
#'
#'@examples
...
#' save(Regions_stations_pop, file = "Regions_stations_pop.rdata")
#' }
"Regions_stations_pop"