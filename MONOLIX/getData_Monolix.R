...
SPF_I_SURSAUD_H_covid19fr$ascertainement<-(ascertainement13+ascertainement)/2
quantile(SPF_I_SURSAUD_H_covid19fr$ascertainement,0.975)  
quantile(SPF_I_SURSAUD_H_covid19fr$ascertainement,0.025)  
...
### SAVE DATASET
write.table(SPF_I_SURSAUD_H_covid19fr,file=paste("./MONOLIX/data_monolix_",date,".txt",sep=""),sep="\t",row.names = F,quote=F)
...
date<-"20200325"
write.table(SPF_I_SURSAUD_H_covid19fr_small,file=paste("./MONOLIX/data_monolix_",date,".txt",sep=""),sep="\t",row.names = F,quote=F)
